...
VOCAB=model.hi-en.spm
SRC=hi
TRG=en
CORPUS_SRC=/fs/surtr0/gnail/hplt/bitextor-mt-models/hin-eng/data/train/train.$SRC.gz
CORPUS_TRG=/fs/surtr0/gnail/hplt/bitextor-mt-models/hin-eng/data/train/train.$TRG.gz

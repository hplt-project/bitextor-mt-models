...
$MARIAN/marian -c training.yml -c student*.yml -c extra.yml \
    ...
    --train-sets ${BASE}/data/train-alt/train.{$SRC,$TRG}.gz \
    --tempdir /tmp \
    --vocabs ${BASE}/vocab/v2/model.$SRC-$TRG.spm{,} \
    --dim-vocabs 32000 32000 \
    --valid-metrics chrf bleu ce-mean-words \
    --valid-sets ${BASE}/data/train-alt/valid.{$SRC,$TRG}.gz --valid-translation-output devset.out --quiet-translation \
    --log-level=info \

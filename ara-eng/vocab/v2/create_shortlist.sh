...
VOCAB=model.ar-en.spm
SRC=ar
TRG=en
CORPUS_SRC=/fs/surtr0/gnail/hplt/bitextor-mt-models/ara-eng/data/train-alt/train.$SRC.gz
CORPUS_TRG=/fs/surtr0/gnail/hplt/bitextor-mt-models/ara-eng/data/train-alt/train.$TRG.gz

BIN=/fs/surtr0/gnail/hplt/students/train-student/alignment/bin
